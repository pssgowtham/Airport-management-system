...
export default function Edit() {
  ...
  const Add = async (e) => {
    e.preventDefault();
    console.log(data)
    await axios.post("http://35.90.111.36:5010/adddata", data).then(res => res.msg).then(alert("Arrival Flight Data Added Successfully"))
  }
  ...
  const Delete = async (e) => {
    e.preventDefault();
    console.log(del)
    await axios.post("http://35.90.111.36:5010/deldata", del).then(res => res.msg).then(alert("Arrival Flight Data Deleted successfuly"))
  }
  ...
  const Update = async (e) => {
    e.preventDefault();
    console.log(del)
    await axios.post("http://35.90.111.36:5010/update", update).then(res => {
      let data = res.data;
      console.log(res.data)
      if (data === "record inserted") {
        alert("Arrival Flight Schedule Data Updated Successfully");
      }
      else {
        alert("Wrong Id");
      }
